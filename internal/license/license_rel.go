...
import (
	...
	dms_aes "github.com/actiontech/dms/pkg/dms-common/pkg/aes"
)

var RelAesKey = []byte("QB1F77DS78C5394BDA6B65BKB5B19P5B")

var relAse = dms_aes.NewEncryptor(RelAesKey)
...
var (
	...
	ErrLicenseExist       = errors.New("license already exist")
)
...
func (l *LicenseContent) Encode() (text string, err error) {
	...
	ret = append(ret, l.LicenseId, licenseInfo)
