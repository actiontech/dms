...
var OpPermissionNameByUID = map[string]*i18n.Message{
	pkgConst.UIDOfOpPermissionProjectDirector:         locale.NameOpPermissionProjectDirector,
	...
	pkgConst.UIDOfOpPermissionViewSQLInsight:          locale.NameOpPermissionViewSQLInsight,
	...
	pkgConst.UIDOfOpPermissionPlatformConfigure:       locale.NameOpPermissionPlatformConfigure,
	pkgConst.UIDOfOpPermissionOperationAudit:          locale.NameOpPermissionOperationAudit,
	...
	pkgConst.UIdOfOpPermissionMaskingAudit:            locale.NameOpPermissionMaskingAudit,
}

var OpPermissionDescByUID = map[string]*i18n.Message{
	pkgConst.UIDOfOpPermissionProjectDirector:         locale.DescOpPermissionProjectDirector,
	...
	pkgConst.UIDOfOpPermissionViewSQLInsight:          locale.DescOpPermissionViewSQLInsight,
	...
	pkgConst.UIDOfOpPermissionPlatformConfigure:       locale.DescOpPermissionPlatformConfigure,
	pkgConst.UIDOfOpPermissionOperationAudit:          locale.DescOpPermissionOperationAudit,
	...
	pkgConst.UIDOfOpPermissionViewExportTask:          locale.DescOpPermissionViewExportTask,
	pkgConst.UIDOfPermissionViewQuickAuditRecord:      locale.DescPermissionViewQuickAuditRecord,
	pkgConst.UIDOfOpPermissionViewIDEAuditRecord:      locale.DescOpPermissionViewIDEAuditRecord,
	pkgConst.UIDOfOpPermissionViewOptimizationRecord:  locale.DescOpPermissionViewOptimizationRecord,
	pkgConst.UIDOfOpPermissionViewVersionManage:       locale.DescOpPermissionViewVersionManage,
	pkgConst.UIDOfOpPermissionVersionManage:           locale.DescOpPermissionVersionManage,
	pkgConst.UIdOfOpPermissionViewPipeline:            locale.DescOpPermissionViewPipeline,
	pkgConst.UIdOfOpPermissionManageProjectDataSource: locale.DescOpPermissionManageProjectDataSource,
	pkgConst.UIdOfOpPermissionManageAuditRuleTemplate: locale.DescOpPermissionManageAuditRuleTemplate,
	pkgConst.UIdOfOpPermissionManageApprovalTemplate:  locale.DescOpPermissionManageApprovalTemplate,
	pkgConst.UIdOfOpPermissionManageMember:            locale.DescOpPermissionManageMember,
	pkgConst.UIdOfOpPermissionPushRule:                locale.DescOpPermissionPushRule,
	pkgConst.UIdOfOpPermissionMangeAuditSQLWhiteList:  locale.DescOpPermissionMangeAuditSQLWhiteList,
	pkgConst.UIdOfOpPermissionManageSQLMangeWhiteList: locale.DescOpPermissionManageSQLMangeWhiteList,
	pkgConst.UIdOfOpPermissionManageRoleMange:         locale.DescOpPermissionManageRoleMange,
	pkgConst.UIdOfOpPermissionDesensitization:         locale.DescOpPermissionDesensitization,
	pkgConst.UIdOfOpPermissionMaskingAudit:            locale.DescOpPermissionMaskingAudit,
}
...
func (d *DMSService) ListOpPermissions(ctx context.Context, req *dmsV1.ListOpPermissionReq) (reply *dmsV1.ListOpPermissionReply, err error) {
	...
	for i, o := range ops {
		...
		opPermissionName := o.Name
		if msg, ok := OpPermissionNameByUID[o.GetUID()]; ok && msg != nil {
			opPermissionName = locale.Bundle.LocalizeMsgByCtx(ctx, msg)
		}

		opPermissionDesc := ""
		if msg, ok := OpPermissionDescByUID[o.GetUID()]; ok && msg != nil {
			opPermissionDesc = locale.Bundle.LocalizeMsgByCtx(ctx, msg)
		}

		ret[i] = &dmsV1.ListOpPermission{
			OpPermission: dmsV1.UidWithName{
				Uid:  o.GetUID(),
				Name: opPermissionName,
			},
