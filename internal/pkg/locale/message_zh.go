...
var (
	...
	NameOpPermissionGlobalManagement       = &i18n.Message{ID: "NameOpPermissionGlobalManagement", Other: "全局管理"}
	NameOpPermissionGlobalView             = &i18n.Message{ID: "NameOpPermissionGlobalView", Other: "全局浏览"}
