...
var (
	...
	OpRecordUnmaskingAPICreate                       = &i18n.Message{ID: "OpRecordUnmaskingAPICreate", Other: "提交查看原文工单申请"}
	OpRecordUnmaskingSubmitWithWorkflowUID           = &i18n.Message{ID: "OpRecordUnmaskingSubmitWithWorkflowUID", Other: "提交查看原文工单 %s"}
	OpRecordUnmaskingApproveWithWorkflowUID          = &i18n.Message{ID: "OpRecordUnmaskingApproveWithWorkflowUID", Other: "审批通过查看原文工单 %s"}
	OpRecordUnmaskingRejectWithWorkflowUID           = &i18n.Message{ID: "OpRecordUnmaskingRejectWithWorkflowUID", Other: "驳回查看原文工单 %s"}
	OpRecordUnmaskingViewDetailWithWorkflowUID       = &i18n.Message{ID: "OpRecordUnmaskingViewDetailWithWorkflowUID", Other: "查看查看原文工单详情 %s"}
	OpRecordUnmaskingViewOriginalWithWorkflowUID     = &i18n.Message{ID: "OpRecordUnmaskingViewOriginalWithWorkflowUID", Other: "查看原文（SQL）%s"}
	OpRecordUnmaskingDownloadOriginalWithWorkflowUID = &i18n.Message{ID: "OpRecordUnmaskingDownloadOriginalWithWorkflowUID", Other: "下载原文数据 %s"}
	OpRecordUnmaskingCancelWithWorkflowUID           = &i18n.Message{ID: "OpRecordUnmaskingCancelWithWorkflowUID", Other: "撤回查看原文工单 %s"}
	OpRecordUnmaskingUnknownWithWorkflowUID          = &i18n.Message{ID: "OpRecordUnmaskingUnknownWithWorkflowUID", Other: "查看原文工单操作 %s (%s)"}
)

// Unmasking Workflow
var (
	SqlWorkbenchUnmaskingNoPermissionErr     = &i18n.Message{ID: "SqlWorkbenchUnmaskingNoPermissionErr", Other: "您没有查看原文的权限，请提交查看原文工单"}
	SqlWorkbenchUnmaskingWorkflowNotFoundErr = &i18n.Message{ID: "SqlWorkbenchUnmaskingWorkflowNotFoundErr", Other: "未找到对应的查看原文工单"}
)
